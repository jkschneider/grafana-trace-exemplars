define(["@grafana/ui","d3","react"], function(__WEBPACK_EXTERNAL_MODULE__grafana_ui__, __WEBPACK_EXTERNAL_MODULE_d3__, __WEBPACK_EXTERNAL_MODULE_react__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ "../node_modules/css-loader/dist/cjs.js?!../node_modules/postcss-loader/src/index.js?!../node_modules/sass-loader/dist/cjs.js!./Heatmap.css":
/*!***********************************************************************************************************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js??ref--7-1!../node_modules/postcss-loader/src??ref--7-2!../node_modules/sass-loader/dist/cjs.js!./Heatmap.css ***!
  \***********************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// Module
exports.push([module.i, ".grid-line {\n  stroke: #bbb;\n  stroke-width: 1; }\n\n.grid-line.dark {\n  stroke: #333; }\n\n.heatmap-bucket {\n  fill: #eee;\n  stroke: #bbb;\n  stroke-width: 1; }\n\n.heatmap-bucket.dark {\n  fill: #222;\n  stroke: #333; }\n\n.axis.dark {\n  fill: #ccc; }\n\n.trace-marker {\n  fill: magenta; }\n", "",{"version":3,"sources":["Heatmap.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,eAAe,EAAE;;AAEnB;EACE,YAAY,EAAE;;AAEhB;EACE,UAAU;EACV,YAAY;EACZ,eAAe,EAAE;;AAEnB;EACE,UAAU;EACV,YAAY,EAAE;;AAEhB;EACE,UAAU,EAAE;;AAEd;EACE,aAAa,EAAE","file":"Heatmap.css","sourcesContent":[".grid-line {\n  stroke: #bbb;\n  stroke-width: 1; }\n\n.grid-line.dark {\n  stroke: #333; }\n\n.heatmap-bucket {\n  fill: #eee;\n  stroke: #bbb;\n  stroke-width: 1; }\n\n.heatmap-bucket.dark {\n  fill: #222;\n  stroke: #333; }\n\n.axis.dark {\n  fill: #ccc; }\n\n.trace-marker {\n  fill: magenta; }\n"]}]);
...
var content = __webpack_require__(/*! !../node_modules/css-loader/dist/cjs.js??ref--7-1!../node_modules/postcss-loader/src??ref--7-2!../node_modules/sass-loader/dist/cjs.js!./Heatmap.css */ "../node_modules/css-loader/dist/cjs.js?!../node_modules/postcss-loader/src/index.js?!../node_modules/sass-loader/dist/cjs.js!./Heatmap.css");
...
/* harmony import */ var _Heatmap_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Heatmap.css */ "./Heatmap.css");
/* harmony import */ var _Heatmap_css__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_Heatmap_css__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _timeFormat__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./timeFormat */ "./timeFormat.ts");
...
var mapNumber = function mapNumber(N, mapping) {
...
function Heatmap(props) {
  var width = props.width - Y_AXIS_WIDTH;
  var height = props.height - X_AXIS_HEIGHT;

  var bucketFilter = function bucketFilter(bucket) {
    return bucket.value >= props.minBucket && bucket.value <= props.maxBucket;
  };

  var maxValue = Math.max.apply(Math, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](props.timeslices.flatMap(function (timeslice) {
    return timeslice.buckets.filter(bucketFilter).map(function (bucket) {
      return bucket.count;
    });
  })));
  var minTime = props.timeslices.length > 0 ? props.timeslices[0].timestamp : 0;
  var maxTime = props.timeslices.length > 0 ? props.timeslices[props.timeslices.length - 1].timestamp : 0; // timeslice index with the most buckets

  var maxBucketTimesliceIndex = props.timeslices.reduce(function (acc, cur, index) {
    var filteredBuckets = cur.buckets.filter(bucketFilter);
    return filteredBuckets.length > acc.bucketLength ? {
      index: index,
      bucketLength: filteredBuckets.length
    } : acc;
  }, {
    index: -1,
    bucketLength: -1
  }).index;
  var bucketRange = props.timeslices[maxBucketTimesliceIndex].buckets.filter(bucketFilter);
  var colorScale = d3__WEBPACK_IMPORTED_MODULE_1__["scaleSequential"](d3_scale_chromatic__WEBPACK_IMPORTED_MODULE_2__["interpolateSpectral"]).domain([maxValue, 0]);
  var bucketHeight = props.timeslices.length > 0 ? height / bucketRange.length : 0;
  var bucketWidth = width / props.timeslices.length; // x-axis settings
  //  const xTicks = width / (Math.ceil(X_TICK_SIZE_PX / bucketWidth) * bucketWidth);

  var xTicks = Math.floor(props.timeslices.length / Math.ceil(X_TICK_SIZE_PX / bucketWidth));
  var xTickIndexIncrement = Math.floor((props.timeslices.length - 1) / (xTicks - 1));
  var chartTimeFormat = Object(_timeFormat__WEBPACK_IMPORTED_MODULE_7__["timeFormat"])(xTicks, minTime, maxTime); // FIXME offset for custom timezones

  var xAxisFormat = props.timezone === 'utc' ? d3__WEBPACK_IMPORTED_MODULE_1__["utcFormat"](chartTimeFormat) : d3__WEBPACK_IMPORTED_MODULE_1__["timeFormat"](chartTimeFormat); // y-axis settings

  var yTicks = Math.floor(bucketRange.length / Math.ceil(Y_TICK_SIZE_PX / bucketHeight));
  var yTickIndexIncrement = Math.floor((bucketRange.length - 1) / (yTicks - 1));

  var yAxisFormat = function yAxisFormat(bucket) {
    return bucket === Infinity ? '+Inf' : Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["getValueFormat"])(props.units || 'none')(bucket, props.decimals);
  };

  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("svg", {
    className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('heatmap', {
      'dark': props.dark
    }),
    viewBox: "0 0 " + props.width + " " + props.height
  }, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("g", null, // y-axis
  maxBucketTimesliceIndex > -1 && mapNumber(yTicks, function (tick) {
  ...
  })), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("g", null, // x-axis
  maxBucketTimesliceIndex > -1 && mapNumber(xTicks, function (tick) {
    var index = tick * xTickIndexIncrement;
    var lastTick = tick === xTicks - 1;
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("text", {
      key: "xaxis-" + tick,
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('axis', {
        'dark': props.dark
  ...
  })), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("g", null, // horizontal grid
  maxBucketTimesliceIndex > -1 && mapNumber(bucketRange.length + 1, function (bucketIndex) {
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("line", {
      key: "hgrid-" + bucketIndex,
      x1: Y_AXIS_WIDTH,
      x2: props.width,
      y1: bucketIndex * bucketHeight,
      y2: bucketIndex * bucketHeight,
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('grid-line', {
        'dark': props.dark
      })
    });
  })), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("g", null, // vertical grid
  mapNumber(props.timeslices.length + 1, function (timesliceIndex) {
    var x = Y_AXIS_WIDTH + timesliceIndex * bucketWidth;
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("line", {
  ...
  })), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("g", null, // colored heatmap cells
  props.timeslices.flatMap(function (timeslice, timesliceIndex) {
    return timeslice.buckets.filter(bucketFilter).map(function (bucket, bucketIndex) {
      var x = timesliceIndex * bucketWidth + Y_AXIS_WIDTH;
      var y = (bucketRange.length - bucketIndex - 1) * bucketHeight;
      var bucketHeatFill = bucket.count === 0 ? {} : {
        fill: colorScale(bucket.count)
      };
      var bucketHeatRect = react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("rect", {
        className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('heatmap-bucket', {
          'dark': props.dark
        }),
        width: bucketWidth,
        height: bucketHeight,
...
/***/ "./TraceExemplarPanel.tsx":
/*!********************************!*\
  !*** ./TraceExemplarPanel.tsx ***!
  \********************************/
/*! exports provided: TraceExemplarPanel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TraceExemplarPanel", function() { return TraceExemplarPanel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _Heatmap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Heatmap */ "./Heatmap.tsx");
...
var TraceExemplarPanel = function TraceExemplarPanel(_a) {
  ...
  var prometheusToHeatmap = function prometheusToHeatmap(data) {
    return data.series.length === 0 ? [] : data.series[0].rows.map(function (_a, index) {
      ...
      }).sort(function (bucket1, bucket2) {
        return bucket1.value - bucket2.value;
  ...
  // want 10
  // 13/10 = ceil(1.3) = 2
  // 2, 2, 2, 2, 2, 2, 1 (7 buckets)
  // have 199
  // want 100
  // 199/100 = 1.99


  var aggregateTimeSeries = function aggregateTimeSeries(timeslices) {
    var maxSeries = options.aggregations.maxSeries || 100;
    var slicesToAggregate = Math.ceil(timeslices.length / maxSeries);
    return timeslices.reduce(function (aggregatedTimeslices, cur, index) {
      if (index % slicesToAggregate === 0) {
        ...
        aggregatedTimeslices.push({
          timestamp: cur.timestamp,
          buckets: cur.buckets
        });
      } else {
        aggregatedTimeslices[aggregatedTimeslices.length - 1].buckets.forEach(function (bucket, i) {
          if (!cur.buckets[i]) {
            return;
          }

          var curCount = cur.buckets[i].count;
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Heatmap__WEBPACK_IMPORTED_MODULE_2__["Heatmap"], {
    width: width,
    height: height,
...
/***/ "./TraceExemplarPanelEditor.tsx":
/*!**************************************!*\
  !*** ./TraceExemplarPanelEditor.tsx ***!
  \**************************************/
/*! exports provided: TraceExemplarPanelEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TraceExemplarPanelEditor", function() { return TraceExemplarPanelEditor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
var TraceExemplarPanelEditor =
/** @class */
function (_super) {
  tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TraceExemplarPanelEditor, _super);

  function TraceExemplarPanelEditor() {
    ...
    _this.onDefaultsChange = function (field) {
      _this.onDisplayOptionsChanged(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.props.options.fieldOptions, {
        defaults: field
      }));
    };

    _this.onAggregationOptionsChange = function (options) {
  ...
  TraceExemplarPanelEditor.prototype.render = function () {
    var _this = this;
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["PanelOptionsGrid"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["PanelOptionsGroup"], {
      title: "Y-Axis"
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["FieldPropertiesEditor"], {
      showMinMax: true,
    ...
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h4", null, "Time Domain"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      className: "gf-form"
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      className: "gf-form-label"
    }, "Max Series"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Input"], {
      className: "gf-form-input width-5",
      type: "number",
      value: options.aggregations.maxSeries,
      placeholder: "Auto",
      onChange: function onChange(event) {
        _this.onAggregationOptionsChange(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, options, {
  ...
  return TraceExemplarPanelEditor;
...
/* harmony import */ var _TraceExemplarPanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TraceExemplarPanel */ "./TraceExemplarPanel.tsx");
/* harmony import */ var _TraceExemplarPanelEditor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TraceExemplarPanelEditor */ "./TraceExemplarPanelEditor.tsx");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./types */ "./types.ts");




var plugin = new _grafana_ui__WEBPACK_IMPORTED_MODULE_0__["PanelPlugin"](_TraceExemplarPanel__WEBPACK_IMPORTED_MODULE_1__["TraceExemplarPanel"]).setDefaults(_types__WEBPACK_IMPORTED_MODULE_3__["defaults"]).setEditor(_TraceExemplarPanelEditor__WEBPACK_IMPORTED_MODULE_2__["TraceExemplarPanelEditor"]);
